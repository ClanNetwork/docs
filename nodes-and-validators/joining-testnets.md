...
| ------------- | -------------------------- | :----------------------------: | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| playstation-2 | v1.0.4-alpha               | airdrop and pre-mainnet launch | - block explorer: [https://secretnodes.com/clan/chains/playstation-2](https://secretnodes.com/clan/chains/playstation-2) - faucet: [https://faucet-testnet.clan.network/](https://faucet-testnet.clan.network/) - stake / vote (also available on block explorer): [https://stake-testnet.clan.network/](https://stake-testnet.clan.network/) | current |
